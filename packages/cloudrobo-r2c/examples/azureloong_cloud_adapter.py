"""
AzureLoong Cloud Adapter example.
...
Usage examples:
    python examples/azureloong_cloud_adapter.py
    python examples/azureloong_cloud_adapter.py --project-id test-tenant --device-id azureloong-robot-01
    python examples/azureloong_cloud_adapter.py --duration 30
"""
...
ADAPTER_NAME = "AzureLoongCloudAdapter"
DEFAULT_PROJECT_ID = "test-tenant"
DEFAULT_DEVICE_ID = "azureloong-robot-01"
DEFAULT_CLIENT_ID = "azureloong-cloud-adapter"

AZURELOONG_DEFAULT_JOINT_NAMES = [
    # 左臂（7个）- 对应训练数据索引 0-6
...
def parse_args() -> argparse.Namespace:
    ...
    parser = build_parser(
        description="AzureLoong cloud adapter: subscribe to observations and publish zero-action",
...
def main() -> None:
    """Run the AzureLoong cloud adapter example."""
    args = parse_args()
    run_cloud_adapter(
        args=args,
        adapter_name=ADAPTER_NAME,
        action_default_joint_names=AZURELOONG_DEFAULT_JOINT_NAMES,
